...
const translations = {
  pl: {
    ...
    // Video/Podcasts page
    videoPodcastsTitle: "Wideo i Podcasty",
    videoPodcastsDescription: "Analiza Twoich danych wideo i podcastów ze Spotify",
    selectProfileForVideo: "Wybierz profil, aby wyświetlić dane wideo", 
    videoPlaysStats: "Odtworzeń wideo",
    videoMinutesStats: "Minut wideo",
  ...
  en: {
    ...
    // Video/Podcasts page
    videoPodcastsTitle: "Video & Podcasts",
    videoPodcastsDescription: "Analysis of your video and podcast data from Spotify",
    selectProfileForVideo: "Select profile to display video data",
    videoPlaysStats: "Video plays",
    videoMinutesStats: "Video minutes",

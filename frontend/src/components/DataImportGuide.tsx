        ...
        <Card className="mt-8">
            ...
            {isExpanded && (
                ...
                <div className="flex gap-3 sm:gap-4">
                    ...
                    <div className="space-y-1 sm:space-y-2 min-w-0">
                        ...
                        <div className="text-xs sm:text-sm text-muted-foreground space-y-2">
                            <p>{t('step2Description')} <code className="bg-muted px-1 rounded text-xs">data/</code>:</p>
                            <div className="bg-muted p-2 sm:p-3 rounded-lg font-mono text-xs overflow-x-auto">
                                <div>data/</div>
                                <div>├── Jan/</div>
                                <div className="pl-2 sm:pl-0">│   ├── Streaming_History_Audio_2017-2019_0.json</div>
                                <div className="pl-2 sm:pl-0">│   ├── Streaming_History_Audio_2019-2020_1.json</div>
                                <div className="pl-2 sm:pl-0">│   └── ...</div>
                                <div>├── Adam/</div>
                                <div className="pl-2 sm:pl-0">│   ├── Streaming_History_Audio_2021_3.json</div>
                                <div className="pl-2 sm:pl-0">│   └── ...</div>
                                <div>└── Anna/</div>
                                <div className="pl-2 sm:pl-0">    └── ...</div>
                            </div>
                            <div className="bg-orange-50 dark:bg-orange-950/30 p-2 sm:p-3 rounded-lg border border-orange-200 dark:border-orange-800">
                                <p className="text-xs sm:text-sm text-orange-800 dark:text-orange-200 font-medium mb-1">
                                    {t('step2FolderNaming')}
                                </p>
                            </div>
                        </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-950/30 p-3 sm:p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                    <h5 className="font-medium text-blue-900 dark:text-blue-100 mb-2 flex items-center gap-2 text-sm sm:text-base">
                        <Info className="h-3 w-3 sm:h-4 sm:w-4" />
                        {t('importantInfo')}
                    </h5>
                    <ul className="text-xs sm:text-sm space-y-1 text-blue-800 dark:text-blue-200">
                        <li>• {t('info1')}</li>
                        <li>• {t('info2')}</li>
                        <li>• {t('info3')}</li>
                        <li>• {t('info4')}</li>
